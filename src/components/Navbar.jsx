...
const Navbar = () => {
    return (
        <div className='h-[10vh] bg-green-950 text-2xl font-bold flex items-center justify-around '>
            ...
            <button className='flex items-center gap-2 text-lg border border-white rounded-full p-[4px] text-white'>
                <a class="flex gap-2" href="https://github.com/k-Mahesh-Babu" target='__blank__'>
                 <div><svg
